...
public class OrderDetailShipments {
	...
	public OrderDetailShipments(Integer shipmentId, Integer orderDetailId,
			String shipmentInformation, Integer logisticServiceId,
			Integer logisticServiceModeId, String carrierName,
			String carrierTrackingId, boolean isOtherLogisticService,
