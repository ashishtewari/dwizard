...
public class OrderDetailReturnShipments {
	...
	public OrderDetailReturnShipments(Integer shipmentId,
			...
			boolean isOtherLogisticService, boolean isDefault, boolean active) {
