...
public interface CustomerAuthenticationDAO {
	...
	@SqlQuery("SELECT mk_api_consumer.id,mk_api_consumer.a_is_active,mk_api_resources_consumer_permission.a_have_get_permission,mk_api_resources_consumer_permission.a_have_post_permission,mk_api_resources_consumer_permission.a_have_put_permission,mk_api_resources_consumer_permission.a_have_delete_permission FROM mk_api_consumer JOIN mk_api_resources_consumer_permission ON mk_api_consumer.id = mk_api_resources_consumer_permission.a_consumer_id WHERE mk_api_consumer.a_access_token = :authenticatonKey")
